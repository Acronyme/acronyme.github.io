  ...
  var content=document.getElementsByClassName("main-content")[0];
   ...
   (function changeColor(){
         ...
         wrapper.style.background="-webkit-gradient(linear, left top,left bottom,form(#"+Math.floor(Math.random()*0xFFFFFF).toString(16)+"),to(#"+Math.floor(Math.random()*0xFFFFFF).toString(16)+"))";
          }
          //判断电脑端
          else if(isChrome){
